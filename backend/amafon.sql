DROP DATABASE IF EXISTS AmafonDB;
CREATE DATABASE IF NOT EXISTS AmafonDB;
USE AmafonDB;
...
-----------------------------------------------------
-- POST-SETUP FIXES AND MAINTENANCE
-----------------------------------------------------

-- Drop the existing foreign key constraint on OrderItems
